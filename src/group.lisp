...
(defmethod closer-mop:slot-value-using-class ((class control-metaclass) (object group) (slot closer-mop:standard-effective-slot-definition))
...
(defmethod (setf closer-mop:slot-value-using-class) (new-value (class control-metaclass) (object group) (slot closer-mop:standard-effective-slot-definition))
  (if (eql :ui-instance (closer-mop:slot-definition-allocation slot))
    (switch ((closer-mop:slot-definition-name slot) :test #'equal)
      ('margined
