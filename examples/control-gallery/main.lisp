...
(defun make-data-choosers-page ()
  (let ((hbox (make-instance 'ui:horizontal-box :padded t)))
    ...
    (let ((vbox (make-instance 'ui:vertical-box :padded t))
      ...
      (ui:append-child g *open-button* :left 0 :top 0 :xspan 1 :yspan 1 :halign :align-fill :valign :align-fill)
      (setq *open-entry* (make-instance 'ui:entry :read-only t))
      (ui:append-child g *open-entry* :left 1 :top 0 :xspan 1 :yspan 1 :hexpand t :halign :align-fill :valign :align-fill)
      (setq *save-button* (make-instance 'ui:button :text "Save File"))
      (ui:append-child g *save-button* :left 0 :top 1 :xspan 1 :yspan 1 :halign :align-fill :valign :align-fill)
      (setq *save-entry* (make-instance 'ui:entry :read-only t))
      (ui:append-child g *save-entry* :left 1 :top 1 :xspan 1 :yspan 1 :hexpand t :halign :align-fill :valign :align-fill)
      (setq *msg-button* (make-instance 'ui:button :text "Message Box"))
      (ui:append-child g *msg-button* :left 0 :top 2 :xspan 1 :yspan 1 :halign :align-fill :valign :align-fill)
      (setq *err-button* (make-instance 'ui:button :text "Error Box"))
      (ui:append-child g *err-button* :left 0 :top 3 :xspan 1 :yspan 1 :halign :align-fill :valign :align-fill))
    hbox))
